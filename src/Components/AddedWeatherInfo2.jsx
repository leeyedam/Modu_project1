...
import { useCountryStore2 } from "../Store/useCountryStore2";
...
function AddedWeatherInfo2() {
  ...
  const addedCountryName = weatherList[1]?.countryName;

  useEffect(() => {
    if (!weatherList[1]) return;
...
export default AddedWeatherInfo2;
